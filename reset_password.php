...
if ($conn->connect_error) {
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if (!preg_match('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/', $password)) {
            ...
            $sql1 = "UPDATE login SET password = '$hashed_password' WHERE email = '" . $_SESSION['email'] . "'";
...
<head>
    ...
    <title>Resto - Reset Password</title>
...
<body>
    <div class="login-container">
        <div class="logo">
            <span class="task">Resto</span><span class="mate"></span>
        </div>
